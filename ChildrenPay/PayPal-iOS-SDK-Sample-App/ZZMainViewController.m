...
- (IBAction)pay {
  ...
  PayPalItem *item1 = [PayPalItem itemWithName:@"Pensiión1"
                                  withQuantity:2
                                     withPrice:[NSDecimalNumber decimalNumberWithString:@"400.00"]
                                  withCurrency:@"USD"
                                       withSku:@"Pensiión2"];
  PayPalItem *item2 = [PayPalItem itemWithName:@"Free rainbow patch"
                                  withQuantity:1
                                     withPrice:[NSDecimalNumber decimalNumberWithString:@"200.00"]
                                  withCurrency:@"USD"
                                       withSku:@"Pensiión3"];
  PayPalItem *item3 = [PayPalItem itemWithName:@"Pensiión3)"
                                  withQuantity:1
  ...
  payment.shortDescription = @"Pensión";
